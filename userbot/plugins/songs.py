...
async def _(event):
    ...
    if event.pattern_match.group(2):
        ...
        await edit_or_reply(event, "ماذا يفترض بي ان اجده")
        return
    cat = base64.b64decode("QUFBQUFGRV9vWjVYVE5fUnVaaEtOdw==")
    catevent = await edit_or_reply(event, "**⫷ جاري البحث عن الاغنيه ⫸ **")
    ...
    await catevent.edit("**جاري تنزيل الاغنيه انتظر لحظات **")
