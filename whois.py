...
async def fetch_info(replied_user, event):
    ...
    caption = "<b><i>شههلل كيك 🥺💞 ↫</i></b>\n\n"
    caption += f"<b> اݪاسـٰٖـ๋͜ــمـٰ اݪاوُݪ:</b> {first_name} {last_name}\n"
    caption += f"<b> آلـمـٰعــُڒٍف:</b> {username}\n"
    caption += f"<b> آلـآيدِي:</b> <code>{user_id}</code>\n"
    caption += f"<b> عدٰدٰ صــًـًًـًٍـًٍور آݪبــٰٖــ۫͜ــــروفـﮧ̯͡ــ̷ـــآيݪ:</b> {replied_user_profile_photos_count}\n"
    caption += f"<b> آݪنبــٰٖــ۫͜ــــذِههہ↬ </b> \n<code>{user_bio}</code>\n\n"
    caption += f"<b> ࢪابـطُ اݪحــ۫͜ـسـٰٖـ๋͜ــابـ :</b> "
